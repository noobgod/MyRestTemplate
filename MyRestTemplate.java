package com.xianjinxia.web.cashman.conf;
...
public class MyRestTemplate {
    ...
    protected void init() {
        ...
        poolingHttpClientConnectionManager.setMaxTotal(800); // 最大连接数
        poolingHttpClientConnectionManager.setDefaultMaxPerRoute(300); // 同路由并发数
        ...
        clientHttpRequestFactory.setConnectionRequestTimeout(1000);// 连接不够用的等待时间
